...
class Print_On_Demand_Icon_Changer extends WP_Customize_Control{
    public $type = 'icon';
        ...
        ?>
            <label>
                ...
                <ul class="icon-list clearfix">
                    ...
                    <?php
                    $print_on_demand_icon_changer_array = print_on_demand_icon_changer_array();
                    foreach ($print_on_demand_icon_changer_array as $print_on_demand_Icon_Changer) {
                            $icon_class = $this->value() == $print_on_demand_Icon_Changer ? 'icon-active' : '';
                            echo '<li class='.esc_attr($icon_class).'><i class="'.esc_attr($print_on_demand_Icon_Changer).'"></i>
                            <span class="print-on-demand-social-class">'.esc_attr($print_on_demand_Icon_Changer).'</span>
                            </li>';
                        }
                    ?>
                </ul>
...
function print_on_demand_icon_customize_js() {
     
    wp_enqueue_style( 'font-awesome-1', esc_url(get_template_directory_uri()).'/assets/css/fontawesome-all.css');
    wp_enqueue_script( 'print-on-demand-customize-icon', esc_url(get_template_directory_uri()).'/assets/js/customize-icon.js', array("jquery"),'', true  );
}
add_action( 'customize_controls_enqueue_scripts', 'print_on_demand_icon_customize_js' );

if(!function_exists('print_on_demand_icon_changer_array')){
    function print_on_demand_icon_changer_array(){
        return array("", 
        "fab fa-500px",
